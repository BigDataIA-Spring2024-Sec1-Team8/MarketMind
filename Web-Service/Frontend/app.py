...
def sidebar():
    ...
    if "token" in st.session_state:
        ...
        selection = st.sidebar.radio("Navigation", ["Search", "Wishlist", "Suggested Products", "Search by Image"])
        ...
        with tab1:
            ...
            st.write("Join us on this journey to revolutionize the e-commerce landscape. Welcome to Market Mind - insights meet innovation, and every shopping experience is personalized just for you. 🚀")
